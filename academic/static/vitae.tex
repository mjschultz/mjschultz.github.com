...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lr}
    ...
    \spantab{2}{p{6.5in}}{Observable Networks, Inc.}               \\
    \spantab{2}{p{6.5in}}{
        Designed and developed algorithms to analyze network meta-data for
            malicious behavior; designed a scalable architecture to handle
            growth in customers and data volume.}                  \\
	\\
	{\bf Research Assistant}     & August 2009 -- present          \\
    \spantab{2}{p{6.5in}}{Department of Computer Science and Engineering,
                   Washington University in Saint Louis}           \\
	\spantab{2}{p{6.5in}}{Applied Research Laboratory}             \\
	\\
	{\bf Research Assistant}     & May 2007 -- August 2009         \\
	\spantab{2}{p{6.5in}}{Department of Mathematics, Statistics, 
	               and Computer Science, Marquette University}     \\
	\spantab{2}{p{6.5in}}{Systems Laboratory}                      \\
	\\
	{\bf Developer and Director} & September 2005 -- May 2007      \\
	\spantab{2}{p{6.5in}}{College of Communication, Student Media Interactive, 
                   Marquette University}                           \\
    \spantab{2}{p{6.5in}}{
        Led a team of student developers and designers for the web presence
        of the newspaper, journal, radio, television, and advertising.} \\
\end{tabular*}
